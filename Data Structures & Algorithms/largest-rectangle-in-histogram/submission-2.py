    ...
    def largestRectangleArea(self, heights: List[int]) -> int:
        ...
        for i in range(len(heights)): 
            ...
            while stack and heights[i] < heights[stack[-1]]:
                ...
                # i = 5, stack= [1,3,4] heights[5](4)< heights[stack[-1]](2)
                # i = 6, stack= [1,3,4,5] heights[6](0)< heights[stack[-1]](4)
                # i = 6, stack= [1,3,4] heights[6](0)< heights[stack[-1]](2)
                # i = 6, stack= [1,3] heights[6](0)< heights[stack[-1]](2)
                # i = 6, stack= [1] heights[6](0)< heights[stack[-1]](1)
                ...
                # i = 6, height =4, s=[1,3,4] stack.pop() = 5
                # i = 6, height =2, s=[1,3] stack.pop() = 4
                # i = 6, height =2, s=[1] stack.pop() = 3
                # i = 6, height =1, s=[] stack.pop() = 1
